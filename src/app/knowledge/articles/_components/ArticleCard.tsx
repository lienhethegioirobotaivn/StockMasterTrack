...
export function ArticleCard({ articles }: ArticleCardProps) {
    ...
    return (
      ...
      >
        <Link
          ...
          className="relative aspect-video w-full shrink-0 overflow-hidden rounded-lg sm:w-48 md:w-56"
        >
          <Image
          ...
          />
          <span
            className={`absolute top-2 left-2 rounded bg-white px-2 py-0.5 text-[10px] font-bold uppercase ${
        ...
        <div className="flex flex-col justify-between py-0.5 flex-1">
          <div>
            <Link href={`/knowledge/${article.slug}`} className="group">
          ...
          <div className="mt-4 flex flex-wrap items-center gap-x-4 gap-y-1 text-xs text-gray-400">
            <div className="flex items-center gap-1 sm:gap-2 lg:gap-1.5">
              <div className="relative size-4 shrink-0 rounded-full overflow-hidden">
                <Image
            ...
            <div className="flex items-center gap-1">
              ...
              <span>{article.viewsFormatted}</span>
            </div>
            <div className="flex items-center gap-1">
