...
type CurriculumProps = Pick<StockMasterTrackCourseData, "curriculum">;
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          <h2 className="text-[28px] lg:text-4xl font-extrabold text-gray-900">
            {curriculum.title.text_1}{" "}
            <span className="text-fuchsia-700">{curriculum.title.text_2}</span>
          </h2>
            ...
            return (
              ...
              >
                ...
                <div className="mx-auto mt-8 flex size-16 lg:size-14 items-center justify-center rounded-full bg-fuchsia-50">
                  <LucideIcon
                    name={item.icon}
                    className="size-10 lg:size-8 text-fuchsia-700"
                  />
                </div>
