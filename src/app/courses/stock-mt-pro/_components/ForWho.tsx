...
const FOR_WHO_DATA = {
  ...
  pricing: {
    ...
    benefits: [
      { icon: ShieldCheck, text: "Hệ thống bài giảng cao cấp" },
      { icon: Landmark, text: "Mentor 1-1 & Phân tích danh mục" },
      { icon: Users, text: "Cộng đồng MT Pro Elite" },
      { icon: LineChart, text: "Live Trading hàng tuần" },
    ],
