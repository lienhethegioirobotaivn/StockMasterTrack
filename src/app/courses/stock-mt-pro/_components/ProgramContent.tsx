  ...
  return (
    <section className="bg-[#060606] py-12 font-sans">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="grid gap-4 grid-cols-1 md:grid-cols-3 lg:grid-cols-5 mb-4">
              ...
              >
                <div>
                  <div className="flex items-start gap-3">
                    ...
                    <h3 className="text-[13px] font-bold uppercase text-[#E1BB70] leading-snug pt-1">
                      {item.title}
                    </h3>
                  </div>
                  ...
                  <ul className="mt-5 space-y-3">
                    {item.bullets.map((bullet, bIndex) => (
                      <li
                        key={bIndex}
                        className="flex items-start gap-2 text-[12px] text-neutral-400 font-medium leading-relaxed"
                      >
            ...
            return (
              <div key={index} className="flex items-center gap-4 px-2">
                ...
                <div className="flex flex-col min-w-0">
                  <span className="text-sm font-bold text-[#C3944E] uppercase">
                    {meta.label}
                  </span>
